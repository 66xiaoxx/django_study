...
},beforePageText:"Page",afterPageText:"of {pages}",displayMsg:"显示 {from} 到 {to}，共 {total} 条记录",nav:{first:{iconCls:"pagination-first",handler:function(){
...
$.messager.defaults=$.extend({},$.fn.window.defaults,{ok:"确定",cancel:"关闭",width:300,height:"auto",modal:true,collapsible:false,minimizable:false,maximizable:false,resizable:false,fn:function(){
}});
})(jQuery);
(function($){
